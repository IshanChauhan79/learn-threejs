...
const spotLIghtCamreraHelper = new THREE.CameraHelper(spotLight.shadow.camera);
spotLIghtCamreraHelper.visible = false;

scene.add(spotLIghtCamreraHelper);
...
const pointLightCamreraHelper = new THREE.CameraHelper(
  pointLight.shadow.camera
);
pointLightCamreraHelper.visible = false;
scene.add(pointLightCamreraHelper);
