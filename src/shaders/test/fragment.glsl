...
void main()
{
    ...
    // square1 = step(0.2, square1);

    // float square2 = max(abs(vUv.x - 0.5) , abs(vUv.y - 0.5));
    // square2 = 1.0 - step(0.25, square2);
    ...
    //     vUv.y * 0.2 + 0.4
    //     );
    // float strength = 0.02 / distance(lightUvX, vec2(0.5))  * 0.02 / distance(lightUvY, vec2(0.5)) ;
