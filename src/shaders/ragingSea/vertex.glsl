...
void main()
{
    ...
    for(float i= 1.0; i<= uSmallWaveIteration;i++){
        elevation -=abs(
            cnoise(
                vec3(modelPosition.xz * uSmallWaveFrequency * i,
    ...
    // modelPosition.z = sin(modelPosition.x * uBigWavesFrequency) * uBigWavesElevation;
    // modelPosition.x = sin(modelPosition.z * uBigWavesFrequency) * uBigWavesElevation;
